...
__.lib.getHiddenElementWidthHeight = function(argElement){
...
__.lib.getRealWindowWidth = function(){
...
__.lib.getWidthScrollbar = function(){
	var elmDivInner = jQuery('<div>').css({width: '100%', height: '200px'});
	var elmDivOuter = jQuery('<div>').css({
			visibility: 'hidden'
			,overflow: 'auto'
			,position: 'absolute'
			,top: '-9000px'
		...
		.append(elmDivInner)
	;
	jQuery('body').append(elmDivOuter);
