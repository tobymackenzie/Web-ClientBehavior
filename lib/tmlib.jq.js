...
*/
	__.lib.preloadImagesForElements = function(arguments){
		...
		fncArguments.elmsItems.each(function(){
			fncArguments.imagePaths.push(jQuery(this).attr(fncArguments.attrURLImage));
		});
...
*/
	__.lib.preloadImagesForAnchors = function(arguments){
		...
		fncArguments.elmsAnchors.each(function(){
			fncArguments.imagePaths.push(jQuery(this).attr("href"));
		});
		__.lib.preloadImages(fncArguments);
	}
/*
...
*/
	__.lib.preloadImages = function(arguments){
		...
		jQuery(arguments.imagePaths).each(function(){
			var fncThis = this;
			setTimeout(function(){
