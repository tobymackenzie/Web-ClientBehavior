...
//				}
	...
	__.lib.merge = function(){
		var lclObject = {};
		for(var keyArg in arguments){
			for(var keyProperty in arguments[keyArg])){
				if(arguments[keyArg].hasOwnProperty(keyProperty){
					lclObject[keyProperty] = arguments[keyArg][keyProperty];
				}
			}
		}
		return lclObject;
